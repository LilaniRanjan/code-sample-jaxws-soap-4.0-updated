 ...
 *       &lt;sequence>
 *         &lt;element name="itemNumberDetails" type="{http://xml.amadeus.com/FMPTBQ_24_6_1A}ItemNumberIdentificationType_311627C" maxOccurs="99"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ItemNumberType {
    ...
    protected List<ItemNumberIdentificationType311627C> itemNumberDetails;
     ...
     * {@link ItemNumberIdentificationType311627C }
     * 
     * 
     */
    public List<ItemNumberIdentificationType311627C> getItemNumberDetails() {
        if (itemNumberDetails == null) {
            itemNumberDetails = new ArrayList<ItemNumberIdentificationType311627C>();
        }
