 ...
 *       &lt;sequence>
 *         &lt;element name="ptc" type="{http://xml.amadeus.com/FMPTBQ_24_6_1A}AlphaNumericString_Length1To6" minOccurs="0"/>
 *         &lt;element name="traveller" type="{http://xml.amadeus.com/FMPTBQ_24_6_1A}TravellerDetailsType_313059C" maxOccurs="9" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TravellerReferenceInformationType {
    ...
    protected List<TravellerDetailsType313059C> traveller;
     ...
     * {@link TravellerDetailsType313059C }
     * 
     * 
     */
    public List<TravellerDetailsType313059C> getTraveller() {
        if (traveller == null) {
            traveller = new ArrayList<TravellerDetailsType313059C>();
        }
