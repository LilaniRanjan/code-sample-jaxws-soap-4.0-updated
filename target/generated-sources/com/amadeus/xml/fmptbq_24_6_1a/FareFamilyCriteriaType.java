 ...
 *       &lt;sequence>
 *         &lt;element name="carrierId" type="{http://xml.amadeus.com/FMPTBQ_24_6_1A}AlphaNumericString_Length1To3" maxOccurs="20" minOccurs="0"/>
 *         &lt;element name="rdb" type="{http://xml.amadeus.com/FMPTBQ_24_6_1A}AlphaString_Length1To2" maxOccurs="20" minOccurs="0"/>
 *         &lt;element name="fareFamilyInfo" type="{http://xml.amadeus.com/FMPTBQ_24_6_1A}FareQualifierInformationType" minOccurs="0"/>
 *         &lt;element name="fareProductDetail" type="{http://xml.amadeus.com/FMPTBQ_24_6_1A}FareProductDetailsType" maxOccurs="20" minOccurs="0"/>
 *         &lt;element name="corporateInfo" type="{http://xml.amadeus.com/FMPTBQ_24_6_1A}MultipleIdentificationNumbersTypeI" maxOccurs="20" minOccurs="0"/>
 *         &lt;element name="cabinProduct" type="{http://xml.amadeus.com/FMPTBQ_24_6_1A}CabinClassDesignationType" maxOccurs="6" minOccurs="0"/>
 *         &lt;element name="cabinProcessingIdentifier" type="{http://xml.amadeus.com/FMPTBQ_24_6_1A}AlphaNumericString_Length1To3" minOccurs="0"/>
 *         &lt;element name="dateTimeDetails" type="{http://xml.amadeus.com/FMPTBQ_24_6_1A}ProductDateTimeTypeI_194583C" maxOccurs="20" minOccurs="0"/>
 *         &lt;element name="otherCriteria" type="{http://xml.amadeus.com/FMPTBQ_24_6_1A}CodedAttributeInformationType_120742C" maxOccurs="20" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class FareFamilyCriteriaType {
    ...
    protected List<ProductDateTimeTypeI194583C> dateTimeDetails;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ProductDateTimeTypeI194583C }
     * 
     * 
     */
    public List<ProductDateTimeTypeI194583C> getDateTimeDetails() {
        if (dateTimeDetails == null) {
            dateTimeDetails = new ArrayList<ProductDateTimeTypeI194583C>();
        }
