 ...
 *       &lt;sequence>
 *         &lt;element name="unitNumberDetail" type="{http://xml.amadeus.com/FMPTBQ_24_6_1A}NumberOfUnitDetailsType_312621C" maxOccurs="20"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class NumberOfUnitsType {
    ...
    protected List<NumberOfUnitDetailsType312621C> unitNumberDetail;
     ...
     * {@link NumberOfUnitDetailsType312621C }
     * 
     * 
     */
    public List<NumberOfUnitDetailsType312621C> getUnitNumberDetail() {
        if (unitNumberDetail == null) {
            unitNumberDetail = new ArrayList<NumberOfUnitDetailsType312621C>();
        }
