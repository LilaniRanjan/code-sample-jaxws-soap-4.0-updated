 ...
 *       &lt;sequence>
 *         &lt;element name="dateTimeDetails" type="{http://xml.amadeus.com/FMPCAQ_20_2_1A}DateAndTimeDetailsTypeI_307651C" maxOccurs="2" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DateAndTimeInformationTypeI {
    ...
    protected List<DateAndTimeDetailsTypeI307651C> dateTimeDetails;
     ...
     * {@link DateAndTimeDetailsTypeI307651C }
     * 
     * 
     */
    public List<DateAndTimeDetailsTypeI307651C> getDateTimeDetails() {
        if (dateTimeDetails == null) {
            dateTimeDetails = new ArrayList<DateAndTimeDetailsTypeI307651C>();
        }
