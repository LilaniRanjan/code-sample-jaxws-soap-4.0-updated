 ...
 *       &lt;sequence>
 *         &lt;element name="groupUsage" type="{http://xml.amadeus.com/TFOPCR_19_2_1A}CodedAttributeType_197625S"/>
 *         &lt;element name="paymentData" type="{http://xml.amadeus.com/TFOPCR_19_2_1A}PaymentDataGroupType" minOccurs="0"/>
 *         &lt;element name="paymentStatus" type="{http://xml.amadeus.com/TFOPCR_19_2_1A}PaymentStatusGroupType" minOccurs="0"/>
 *         &lt;element name="paymentSupplementaryData" type="{http://xml.amadeus.com/TFOPCR_19_2_1A}CodedAttributeType_202071S" maxOccurs="99" minOccurs="0"/>
 *         &lt;element name="mopInformation" type="{http://xml.amadeus.com/TFOPCR_19_2_1A}MeanOfPaymentDataType" minOccurs="0"/>
 *         &lt;element name="dummy" type="{http://xml.amadeus.com/TFOPCR_19_2_1A}DummySegmentTypeI"/>
 *         &lt;element name="mopDetailedData" type="{http://xml.amadeus.com/TFOPCR_19_2_1A}DetailedPaymentDataType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PaymentGroupType {
    ...
    protected CodedAttributeType197625S groupUsage;
    protected PaymentDataGroupType paymentData;
    protected PaymentStatusGroupType paymentStatus;
    protected List<CodedAttributeType202071S> paymentSupplementaryData;
     ...
     *     
     */
    public CodedAttributeType197625S getGroupUsage() {
        return groupUsage;
    }
     ...
     *     
     */
    public void setGroupUsage(CodedAttributeType197625S value) {
     ...
     * {@link CodedAttributeType202071S }
     * 
     * 
     */
    public List<CodedAttributeType202071S> getPaymentSupplementaryData() {
        if (paymentSupplementaryData == null) {
            paymentSupplementaryData = new ArrayList<CodedAttributeType202071S>();
        }
