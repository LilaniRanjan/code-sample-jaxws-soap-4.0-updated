 ...
 *       &lt;sequence>
 *         &lt;element name="referencingDetail" type="{http://xml.amadeus.com/FMPTBR_24_6_1A}ReferencingDetailsType_191583C" maxOccurs="200" minOccurs="0"/>
...
public class ReferenceInfoType {
    ...
    protected List<ReferencingDetailsType191583C> referencingDetail;
     ...
     * {@link ReferencingDetailsType191583C }
     * 
     * 
     */
    public List<ReferencingDetailsType191583C> getReferencingDetail() {
        if (referencingDetail == null) {
            referencingDetail = new ArrayList<ReferencingDetailsType191583C>();
        }
