 ...
 *       &lt;sequence>
 *         &lt;element name="productDateTime" type="{http://xml.amadeus.com/FMPTBR_24_6_1A}ProductDateTimeType"/>
 *         &lt;element name="location" type="{http://xml.amadeus.com/FMPTBR_24_6_1A}LocationIdentificationDetailsType" maxOccurs="2"/>
 *         &lt;element name="companyId" type="{http://xml.amadeus.com/FMPTBR_24_6_1A}CompanyIdentificationType" minOccurs="0"/>
 *         &lt;element name="flightOrtrainNumber" type="{http://xml.amadeus.com/FMPTBR_24_6_1A}AlphaNumericString_Length1To8" minOccurs="0"/>
 *         &lt;element name="productDetail" type="{http://xml.amadeus.com/FMPTBR_24_6_1A}AdditionalProductDetailsType" minOccurs="0"/>
 *         &lt;element name="addProductDetail" type="{http://xml.amadeus.com/FMPTBR_24_6_1A}ProductFacilitiesType" minOccurs="0"/>
 *         &lt;element name="attributeDetails" type="{http://xml.amadeus.com/FMPTBR_24_6_1A}CodedAttributeInformationType_299767C" maxOccurs="20" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TravelProductType {
    ...
    protected List<CodedAttributeInformationType299767C> attributeDetails;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CodedAttributeInformationType299767C }
     * 
     * 
     */
    public List<CodedAttributeInformationType299767C> getAttributeDetails() {
        if (attributeDetails == null) {
            attributeDetails = new ArrayList<CodedAttributeInformationType299767C>();
        }
